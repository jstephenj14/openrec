...
for train_iter, batch_data in enumerate(train_dataset.pairwise(batch_size=batch_size,
    ...
    print(batch_data)
    # print('batch_data["user_id"]')
    # print(batch_data["user_id"].numpy())
    # print('batch_data["p_item_id"]')
    # print(batch_data["p_item_id"].numpy())
    # print('batch_data["n_item_id"]')
    # print(batch_data["n_item_id"].numpy())
